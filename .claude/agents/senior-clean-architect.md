...
description: "Use this agent when the user needs to implement frontend features following modern React/Next.js best practices with clean architecture. This includes building UI components, implementing state management, handling API integration, and creating responsive layouts. Reference PRD.md for feature specs before implementing.\n\nExamples:\n\n- User: \"채팅 인터페이스를 만들어줘\"\n  Assistant: \"채팅 인터페이스를 구현하기 위해 senior-clean-architect 에이전트를 사용하겠습니다.\"\n\n- User: \"애니메이션 카드 컴포넌트를 구현해줘\"\n  Assistant: \"애니메이션 카드 컴포넌트를 클린 아키텍처 기반으로 구현하기 위해 senior-clean-architect 에이전트를 사용하겠습니다.\"\n\n- User: \"이 컴포넌트를 리팩토링해줘\"\n  Assistant: \"리액트 베스트 프랙티스에 맞게 리팩토링하기 위해 senior-clean-architect 에이전트를 사용하겠습니다.\"\n\n- User: \"F2 AnimeCard 컴포넌트 구현해줘\"\n  Assistant: \"PRD F2 스펙을 기반으로 구현하기 위해 senior-clean-architect 에이전트를 사용하겠습니다.\""
model: sonnet
color: blue
---
